...
* [**Get-started**](get-started/1-install.qmd) {{< fa book-open-reader >}} Here is where you should start your journey. This is a short introduction to R and RStudio and you MUST go though this session before we start the module. If you are already used to code in R you can skip this part, but if this is your first time coding in R or your skills in R are limited, **YOU CANNOT SKIP THIS STEP**
...
- Complete the **exercise** ({{< fa pen-ruler >}}) using your quarto workbook ({{< fa laptop-code >}}) and submit it to the respective **NOW Dropbox**
