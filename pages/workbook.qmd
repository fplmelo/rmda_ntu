...
1.  In RStudio, with your Quarto project open, you can typically use the **Build** pane. Look for a **Build Website** option. Clicking this will process your project files according to your `_quarto.yml` configuration and generate your website.
