...
knitr::include_graphics("img/render-button.png", error = FALSE)
```

![](img/render-button.png)
...
Page reproduced from: [Andrew Heiss](https://datavizf24.classes.andrewheiss.com/resource/quarto.html)
