...
* [**Get-started**](content/get-started/1.install.qmd) {{< fa book-open-reader >}} Here is where you should start your journey. This is a short introduction to R and RStudio.

* [**Content**](content/index.qmd) <i class="bi bi-columns-gap"></i>
